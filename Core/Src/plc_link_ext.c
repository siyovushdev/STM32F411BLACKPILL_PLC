...
#define PLC_HW_DI_TOTAL 16u
#define PLC_HW_DO_TOTAL 16u
#define PLC_HW_AI_TOTAL 8u
#define PLC_HW_AO_TOTAL 8u
#define PLC_HW_PWM_TOTAL 0u
#define PLC_HW_HSC_TOTAL 3u
#define PLC_HW_ENCODER_TOTAL 2u
