...
/* Definitions for plcScanTask */
osThreadId_t plcScanTaskHandle;
const osThreadAttr_t plcScanTask_attributes = {
  .name = "plcScanTask",
  .stack_size = 512 * 4,
...
/* USER CODE BEGIN Header_StartPlcScanTask */
/**
  * @brief  Function implementing the plcScanTask thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartPlcScanTask */
void StartPlcScanTask(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
